  ...
  scroll: function scroll() {
    ...
    links.forEach(function (link) {
      link.addEventListener('click', function (e) {
        ...
        var isMobile = document.querySelector('.scrollto').classList.contains('active');
        var topOffset;
        if (!isMobile) {
...
/* harmony default export */ var accordeon = ({
  init: function init() {
    var qs = document.querySelectorAll('.faq__item');
...
;// CONCATENATED MODULE: ./src/modules/gsap.js


gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
/* harmony default export */ var modules_gsap = ({
  init: function init() {
    // добавить проверку устройства
    var imgC = document.querySelector('.hero__right');
    ...
    imgC.addEventListener('mousemove', function (e) {
    ...
    gsapWithCSS.from('.advantages__list', {
      scrollTrigger: {
        trigger: '.advantages',
        start: '-550 0',
        // scrub: true,
    ...
    gsapWithCSS.from('.works__item._1', {
      scrollTrigger: {
        trigger: '.works',
        start: '-400 0',
        // scrub: true,
    ...
    gsapWithCSS.from('.works__item._2', {
      scrollTrigger: {
        trigger: '.works',
        start: '-300 0',
        // scrub: true,
    ...
    gsapWithCSS.from('.works__item._3', {
      scrollTrigger: {
        trigger: '.works',
        start: '00 0',
        // scrub: true,
    ...
    gsapWithCSS.from('.works__item._4', {
      scrollTrigger: {
        trigger: '.works',
        start: '300 0',
        // scrub: true,
    ...
    gsapWithCSS.from('.tilda__item._1', {
      scrollTrigger: {
        trigger: '.tilda',
        start: '-850 0',
        // scrub: true,
    ...
    gsapWithCSS.from('.tilda__item._2', {
      scrollTrigger: {
        trigger: '.tilda',
        start: '-850 0',
        // scrub: true,
    ...
    gsapWithCSS.from('.tilda__item._3', {
      scrollTrigger: {
        trigger: '.tilda',
        start: '-850 0',
        // scrub: true,
...
;// CONCATENATED MODULE: ./src/modules/numbers.js
/* harmony default export */ var numbers = ({
  init: function init() {
    var numbers = document.querySelectorAll('.numbers__item-number');
    var number_1 = numbers[0];
    var number_2 = numbers[1];
    var number_3 = numbers[2];
    console.log('number_2', number_2);
    if (!number_1) return;
    var numberTop = number_1.getBoundingClientRect().top;
    var start = +number_1.innerHTML;
    var end = +number_1.dataset.max;
    ...
    var start_2 = +number_2.innerHTML;
    var end_2 = +number_2.dataset.max;
    ...
    var start_3 = +number_3.innerHTML;
    var end_3 = +number_3.dataset.max;
...
/* harmony default export */ var slider = ({
  init: function init() {
    ...
    if (breakpoint.matches === true) {
      swiper.destroy();
      var hiddenSlide = document.querySelector('.process__slide._2');
      hiddenSlide.classList.add('hidden');
      var openBtn = document.querySelector('.more');
...
;// CONCATENATED MODULE: ./src/modules/typet.js
...
/* harmony default export */ var typet = ({
  init: function init() {
    var _Typed;
    var from = document.querySelector('#typed');
    var to = document.querySelector('#typed-strings');
    console.log('dfdfdf', from, to);
    var typed = new i(from, (_Typed = {
      stringsElement: to,
      typeSpeed: 50,
      startDelay: 50,
      backSpeed: 50,
      loop: false
    }, _defineProperty(_Typed, "startDelay", 1200), _defineProperty(_Typed, "showCursor", false), _Typed));
  }
});
...
/* harmony default export */ var modules_form = ({
  init: function init() {
    $('.form__left').on('submit', function (e) {
      e.preventDefault();
    ...
    var masks = document.querySelector('.js-tel');
    ...
    var mask = IMask(masks, maskOptions);
  }
});
